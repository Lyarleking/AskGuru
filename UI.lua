...
UPAdded:addLabel('- New Ice Golem Timer Utility')
UPAdded:addLabel('- New AntiAFK Kick Utility')
UPAdded:addLabel('- Amethyst Island SOON!')
...
getgenv().MultiplierStrength = false
getgenv().MultiplierEndurance = false
getgenv().MultiplierWisdom = false
getgenv().MultiplierAgility = false
getgenv().MultiplierSpeed = false
...
Autofarm:addToggle('Endurance Upgrade', function(bool)
    getgenv().MultiplierEndurance = bool -- :addToggle(Title, callback)
    if bool then
    EnduranceM()
        end
    end)
Autofarm:addToggle('Wisdom Upgrade', function(bool)
    getgenv().MultiplierWisdom = bool -- :addToggle(Title, callback)
    if bool then
    WisdomM()
        end
    end)
Autofarm:addToggle('Agility Upgrade', function(bool)
    getgenv().MultiplierAgility = bool -- :addToggle(Title, callback)
    if bool then
    AgilityM()
        end
    end)
Autofarm:addToggle('Speed Upgrade', function(bool)
    getgenv().MultiplierSpeed = bool -- :addToggle(Title, callback)
    if bool then
    SpeedM()
        end
end)    
